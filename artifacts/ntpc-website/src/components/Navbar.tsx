    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 shrink-0">
          <img src={logoUrl} alt="NTPC Logo" className="h-10 w-10 rounded-full object-cover" />
          <span className="font-serif font-bold text-lg hidden sm:block text-primary">NTPC</span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="absolute -bottom-4 text-[10px] font-bold">{language === 'en' ? 'EN' : 'አማ'}</span>
          </Button>
