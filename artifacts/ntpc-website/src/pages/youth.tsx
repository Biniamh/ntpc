      ...
      <section className="py-20 container px-4 mx-auto max-w-5xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">
            {language === "am" ? "ስለ መልካም ወጣት " : "About Excellent Youth"}
          </h2>
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
            {language === "am"
              ? "መልካም ወጣት ቤተ ክርስቲያናችን ወጣቱ ትውልድ ለክርስቶስ ሙሉ በሙሉ እንዲኖር የሚያዘጋጅ ክፍል ነው። ፕሮግራሞቻቸን፣ ዓመታዊ የክረምት ካምፕ፣ ሳምንታዊ ስብሰባ እና ወጣቶች ዓለምን እንዲቀይሩ ዝቅ ዝቅ ማለት ሁሉ ያካትታል።"
              : "Excellent Youth is the dynamic youth department of NTPC, dedicated to working on the youth who live fully for Christ. Through weekly Bible studies, mentorship, outreach, and our annual transformative winter camp, we equip a generation to be salt and light in their world."}
          </p>
        </div>
        ...
        <div className="container px-4 mx-auto max-w-5xl">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-5xl font-serif font-bold mb-4">
              {language === "am" ? "የክረምት ካምፕ" : "Winter Camp"}
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              {language === "am"
                ? "ዓመቱ በጣም የሚጠበቅ ፕሮግራም — ሰባት ቀናት ቀናቶች ሙሉ ኃይለኛ አምልኮ፣ ትምህርት፣ ጸሎትና ነፃነት። ብዙ ወጣቶች ሕይወታቸው ፈፅሞ ተቀይሮ ወጥቷቸዋል።"
                : "The most anticipated event of the year — seven intense days of powerful worship, Bible teaching, prayer, and deliverance. Hundreds of youth have had life-changing encounters with God at this camp."}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              ...
              {
                num: "500+",
                label: language === "am" ? "ተሳታፊ ወጣቶች" : "Youth Participants",
              },
              {
                num: "100s",
                label: language === "am" ? "ሕይወት የተቀየሩ" : "Lives Transformed",
              },
            ].map((stat, i) => (
              <div
                key={i}
                className="text-center p-8 rounded-2xl border bg-background"
              >
          ...
          <div className="text-center">
            ...
            <Button asChild size="lg" className="rounded-full px-10">
              <Link href="/ey-register">
                {language === "am" ? "ይመዝገቡ" : "Register for Excellent Youth"}
              </Link>
            </Button>
      ...
      <section className="py-16 bg-primary text-primary-foreground text-center">
        <div className="container px-4 mx-auto">
          ...
          <p className="text-primary-foreground/80 text-lg mb-2">
            {language === "am"
              ? "ሁሉም አርብ ከምሽቱ 10:00 — Excellent Youth ስብሰባ!"
              : "Every Friday at 10:00 PM — Excellent Youth Service!"}
          </p>
          <p className="text-primary-foreground/60 text-sm">
            {language === "am"
              ? "ገርጂ፣ አዲስ አበባ"
              : "Gerji, Addis Ababa — All youth welcome!"}
          </p>
        </div>
      </section>
    </div>
